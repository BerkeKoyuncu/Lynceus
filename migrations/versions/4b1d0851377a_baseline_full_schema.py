...
def upgrade():
    ...
    if 'system_setting' not in existing_tables:
        op.create_table(
            ...
            sa.Column('alert_on_new_ports_only', sa.Boolean(), nullable=True),
            sa.Column('honeypot_active', sa.Boolean(), nullable=True),
            sa.Column('honeypot_auto_block', sa.Boolean(), nullable=True),
            sa.Column('honeypot_email_alert', sa.Boolean(), nullable=True),
            sa.Column('scan_freeze_active', sa.Boolean(), nullable=True),
            sa.Column('scan_freeze_start', sa.String(5), nullable=True),
            sa.Column('scan_freeze_end', sa.String(5), nullable=True),
            sa.Column('scan_exclusions_active', sa.Boolean(), nullable=True),
            sa.Column('scan_exclude_targets', sa.Text(), nullable=True),
            sa.Column('created_at', sa.DateTime(), nullable=True),
            sa.ForeignKeyConstraint(['user_id'], ['user.id'], ondelete='CASCADE'),
            sa.PrimaryKeyConstraint('id'),
    ...
    if 'asset' not in existing_tables:
        op.create_table(
            ...
            sa.Column('ip_assignment_type', sa.String(20), nullable=False),
